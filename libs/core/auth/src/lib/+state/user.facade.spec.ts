...
import { USER_FEATURE_KEY, UserState, initialUserState, userReducer } from './user.reducer';
...
describe('UserFacade', () => {
  ...
  describe('used in NgModule', () => {
    beforeEach(() => {
      @NgModule({
        imports: [StoreModule.forFeature(USER_FEATURE_KEY, userReducer), EffectsModule.forFeature([UserEffects])],
