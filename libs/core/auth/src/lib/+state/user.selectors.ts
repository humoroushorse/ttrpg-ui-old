...
export const selectUserEntities = createSelector(selectUserState, (state: UserState) => selectEntities(state));

export const selectSelectedId = createSelector(selectUserState, (state: UserState) => state.selectedId);

export const selectEntity = createSelector(selectUserEntities, selectSelectedId, (entities, selectedId) =>
